...
async def start_comm(client, message: Message, _):
    ...
    if len(message.text.split()) > 1:
        ...
        if name[0:4] == "help":
            ...
            await message.reply_sticker("CAACAgUAAx0CbAnhMwACAmBj4hDUa8v83h3wNnxpUevaV-X7_QACfQkAAhOgEFcgqKXba0r-8R4E")
        ...
        if name[0:3] == "sta":
            ...
            def get_stats():
                ...
                for vidid, count in list_arranged.items():
                    ...
                    if vidid == "telegram":
                        msg += f"🔗[ᴛᴇʟᴇɢʀᴀᴍ ᴍᴇᴅɪᴀ](https://t.me/DopeShope_xD) ** ᴩʟᴀʏᴇᴅ {count} ᴛɪᴍᴇs**\n\n"
                    else:
        ...
        if name == "verify":
            ...
            return
        if name[0:3] == "inf":
            m = await message.reply_text("𝐅𝐞𝐚𝐭𝐜𝐡𝐢𝐧𝐠 𝐘𝐨𝐮𝐫 𝐐𝐮𝐞𝐫𝐢𝐞𝐬 🥵❤")
...
⏳ **ǫᴜᴇʀɪᴇs ᴅᴜʀᴀᴛɪᴏɴ:** {duration} ᴍɪɴᴜᴛᴇs
👀 **ᴛᴏᴛᴀʟ ᴠɪᴇᴡs:** `{views}`
⏰ **ᴩᴜʙʟɪsʜᴇᴅ ᴏɴ:** {published}
😇 **ᴜᴘᴅᴀᴛᴇs ᴄʜᴀɴɴᴇʟ:** [𝗥𝗢𝗦𝗘 𝗨𝗣𝗗𝗔𝗧𝗘𝗦](https://t.me/MissRoseMusic_Update)
❤ **sᴜᴘᴘᴏʀᴛ ᴄʜᴀɴɴᴇʟ:** [𝗗𝗢𝗣𝗘 𝗦𝗛𝗢𝗣𝗘](https://t.me/DopeShope_xD)
😈 **ᴏᴡɴᴇʀ:** [𝗔𝗻𝗸𝗶𝘁⚠️](https://t.me/NotYourAnkit)
🎵 **𝗦𝗼𝘂𝗿𝗰𝗲 𝗖𝗼𝗱𝗲:** [𝗚𝗶𝘁𝗵𝘂𝗯](https://t.me/About_NotAnkit)
            ...
            key = InlineKeyboardMarkup(
                [
                    [
                        ...
                        InlineKeyboardButton(
                            text="➚ 𝙎𝙪𝙥𝙥𝙤𝙧𝙩 ➚", url="https://t.me/DopeShope_xD"
                        ),
                    ],
                ]
            )
...
async def welcome(client, message: Message):
    ...
    if config.PRIVATE_BOT_MODE == str(True):
        if not await is_served_private_chat(message.chat.id):
            await message.reply_text(
                "**ᴩʀɪᴠᴀᴛᴇ ᴍᴜsɪᴄ ʙᴏᴛ**\n\nᴏɴʟʏ ғᴏʀ ᴛʜᴇ ᴄʜᴀᴛs ᴀᴜᴛʜᴏʀɪsᴇᴅ ʙʏ ᴍʏ ᴏᴡɴᴇʀ, ʀᴇǫᴜᴇsᴛ ɪɴ ᴍʏ [ᴏᴡɴᴇʀ's ᴩᴍ](https://t.me/NotYourAnkit) ᴛᴏ ᴀᴜᴛʜᴏʀɪsᴇ ʏᴏᴜʀ ᴄʜᴀᴛ ᴀɴᴅ ɪғ ʏᴏᴜ ᴅᴏɴ'ᴛ ᴡᴀɴᴛ ᴛᴏ ᴅᴏ sᴏ ᴛʜᴇɴ ғᴜ*ᴋ ᴏғғ ʙᴇᴄᴀᴜsᴇ ɪ'ᴍ ʟᴇᴀᴠɪɴɢ."
            )
