...
**𝘽𝙡𝙤𝙘𝙠𝙚𝙙 𝙐𝙨𝙚𝙧𝙨 🖕:** 0  
**𝙎𝙪𝙙𝙤𝙚𝙧𝙨:** 2 
**⚠️ 𝘽𝙤𝙩 𝙊𝙬𝙣𝙚𝙧 ⚠️:** [𝗔𝗻𝗸𝗶𝘁 ⚠️](https://t.me/NotYourAnkit) 
    
**𝙌𝙪𝙚𝙧𝙞𝙚𝙨 😎:** 184977 
**𝘼𝙨𝙨𝙞𝙨𝙩𝙖𝙣𝙩𝙨 ⚡:** {assistant}
**𝘼𝙨𝙨𝙞𝙨𝙩𝙖𝙣𝙩 𝘼𝙪𝙩𝙤 𝙇𝙚𝙖𝙫𝙚 🤏:** {ass}
**𝘾𝙡𝙚𝙖𝙣𝙈𝙤𝙙𝙚 🚫:** {cm} ᴍɪɴᴜᴛᴇs

**𝘿𝙪𝙧𝙖𝙩𝙞𝙤𝙣 𝙇𝙞𝙢𝙞𝙩 🎵:** {play_duration} ᴍɪɴᴜᴛᴇs
**𝘿𝙤𝙬𝙣𝙡𝙤𝙖𝙙 𝙇𝙞𝙢𝙞𝙩 🚫:** {song} ᴍɪɴᴜᴛᴇs
**𝙋𝙡𝙖𝙮𝙡𝙞𝙨𝙩 𝙇𝙞𝙢𝙞𝙩 ✨:** {playlist_limit}
**𝙋𝙡𝙖𝙮𝙡𝙞𝙨𝙩 𝙋𝙡𝙖𝙮 𝙇𝙞𝙢𝙞𝙩 💀:** {fetch_playlist}"""
