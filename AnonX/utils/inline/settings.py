    ...
    buttons = [
        [
            InlineKeyboardButton(
                text="𝗔ᴜᴅɪᴏ 𝗤ᴜᴀʟɪᴛʏ", callback_data="AQ"
            ),
            InlineKeyboardButton(
                text="𝗩ɪᴅᴇᴏ 𝗤ᴜᴀʟɪᴛʏ", callback_data="VQ"
            ),
        ],
        [
            InlineKeyboardButton(
                text="𝗔ᴜᴛʜ 𝗨sᴇʀs", callback_data="AU"
            ),
            InlineKeyboardButton(
                text="𝗖ʟᴇᴀɴ 𝗠ᴏᴅᴇ", callback_data="CM"
            ),
        ],
        [
            InlineKeyboardButton(
                text="• 𝗦ᴜᴩᴩᴏʀᴛ 𝗖ʜᴀᴛ ➚•", url=f"{SUPPORT_GROUP}",
            ),
            InlineKeyboardButton(
